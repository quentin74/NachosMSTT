        ...
        switch(type){
          ...
          case SC_PutString:{
            ...
            char st[MAX_STRING_SIZE];
             DEBUG('a', "Conversion Mips to Linux.\n");
			 CopyStringFromMachine(c,st,MAX_STRING_SIZE);
             DEBUG('a', "Affiche string de mips.\n");
          ...
          case SC_GetString:{
            ...
            CopyMachineFromString(from,to,taille); //copie de chaine linux vers chaine mips 
            delete [] from;
            break;
          }
          case SC_GetChar:{
